        ...
        onSubmit: async (value) => {
            try {
              ...
              formData.append("file", document.querySelector("#file").files[0]);
                ...
                let res = await axios.post("http://localhost:3006/api/newProduct",formData, {
                  headers: {
...
<div className="form-groupii">
        ...
        <div className="form-groupii">
        <input {...formik.getFieldProps("discount")}  id="discount" type="number" className="form-control" name="discount" placeholder="price" />
        </div>
        {/* <div className="form-groupii">
        <input {...formik.getFieldProps("offer price")} type="number"  className="form-control" name="offerprice" id="offerprice" placeholder="offer price" />
        </div> */}
        <div className="form-groupii">
        <input {...formik.getFieldProps("description")} type="text"  className="form-control" name="description" id="description" placeholder="description" />
        </div>
